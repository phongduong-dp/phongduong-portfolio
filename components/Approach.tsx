    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex w-full flex-col items-center justify-center gap-4 lg:flex-row">
        ...
        <Card
          ...
          des="Thoroughly analyzing the your needs and challenges. Engage in detailed discussions to grasp the scope, objectives, and pain points. This ensures that the solution is aligned with the your expectations and business goals."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          des="Once the problem is well-understood, move on to crafting a tailored solution. This involves selecting the right technologies, 
          outlining a clear plan, and creating prototypes or wireframes. 
          The focus here is on creating a solution that is both efficient and scalable."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          title="Iterative Development & Feedback"
          icon={<AceternityIcon order="Phase 3" />}
          des="Develop the solution in stages, incorporating your feedback at every step. 
          This iterative approach allows us to adjust and refine, ensuring that the final product is perfectly aligned with the your vision and the problem effectively."
        >
          <CanvasRevealEffect
            animationSpeed={3}
